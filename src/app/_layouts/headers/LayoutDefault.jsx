            ...
            <div className="container-fluid">
                <div className="mil-top-panel-content">
                    <Link href="/" className="mil-logo">
                        <img src={AppData.header.logo.image} alt={AppData.header.logo.alt} style={{"width": "130px", "filter": "brightness(0) saturate(100%) invert(75%) sepia(0%) saturate(0%) hue-rotate(185deg) brightness(95%) contrast(91%)"}} />
                    </Link>
                    ...
                    <div className="mil-top-panel-buttons">
                        <Link href="#contact" className="mil-button mil-sm">시작하기</Link>
