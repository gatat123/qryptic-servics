            ...
            <div className="row align-items-end">
                ...
                <div className="col-lg-4">
                    <Link href="/" className="mil-footer-logo mil-up mil-mb-30">
                        <img src={AppData.footer.logo.image} alt={AppData.footer.logo.alt} style={{"width": "130px", "filter": "brightness(0) saturate(100%) invert(75%) sepia(0%) saturate(0%) hue-rotate(185deg) brightness(95%) contrast(91%)"}} />
                    </Link>
                </div>
            </div>
        </div>
